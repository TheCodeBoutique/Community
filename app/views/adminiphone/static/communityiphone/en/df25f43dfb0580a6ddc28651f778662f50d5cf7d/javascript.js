...
}if(SC.BUNDLE_INFO[a]){return}SC.BUNDLE_INFO[a]={requires:["sproutcore","sproutcore/animation","sproutcore/table"],styles:["/static/community/en/ace5bf5c17fe8349108a7943c6dc56a6c875f90f/stylesheet-packed.css","/static/community/en/ace5bf5c17fe8349108a7943c6dc56a6c875f90f/stylesheet.css"],scripts:["/static/community/en/ace5bf5c17fe8349108a7943c6dc56a6c875f90f/javascript-packed.js"]}
...
}.property("length").cacheable()});sc_require("models/beta_users");Communityiphone.USER_QUERY=SC.Query.local(Communityiphone.BetaUser);
...
d.push(a);this.set("childViews",d)}});Communityiphone.mainPage=SC.Page.design({classNames:["base-view"],mainPane:SC.MainPane.design({childViews:"middleView topView bottomView".w(),topView:SC.ToolbarView.design({layout:{top:76,left:0,right:0,height:36},classNames:["dark-toolbar"],anchorLocation:SC.ANCHOR_TOP,childViews:"cloudText cloudAlone".w(),cloudText:SC.ImageView.design(SC.Animatable,{layout:{left:10,centerY:0,height:100,width:200},value:"/static/community/en/ace5bf5c17fe8349108a7943c6dc56a6c875f90f/resources/images/cloud_text.png",}),cloudAlone:SC.ImageView.design(SC.Animatable,{layout:{left:200,centerY:0,height:30,width:47},transitions:{opacity:{duration:2,timing:SC.Animatable.TRANSITION_CSS_EASE},},value:"/static/community/en/ace5bf5c17fe8349108a7943c6dc56a6c875f90f/resources/images/clouds_alone.png",})}),middleView:SC.ScrollView.design({classNames:["base-view"],hasHorizontalScroller:NO,layout:{top:0,bottom:0,left:0,right:0},contentView:SC.ListView.design({contentBinding:"Communityiphone.betaController.arrangedObjects",selectionBinding:"Communityiphone.betaController.selection",contentValueKey:"name",exampleView:Communityiphone.ExtendList,hasContentIcon:YES,escapeHTML:NO,fontSize:16,rowHeight:50}),}),bottomView:SC.ToolbarView.design({layout:{bottom:0,left:0,right:0,height:32},classNames:["dark-toolbar"],childViews:"summaryView ".w(),anchorLocation:SC.ANCHOR_BOTTOM,summaryView:SC.LabelView.design({layout:{centerY:0,height:18,left:20,right:20},textAlign:SC.ALIGN_CENTER,classNames:["signup-count"],valueBinding:"Communityiphone.betaController.summary"})})})});
